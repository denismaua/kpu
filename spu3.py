# implements a local search on the space of policies with dominance pruning
from SetFactor import SetFactor, SetFactorProduct, ParetoSetFactorSumBProduct
...
def run(ChanceVars, DecVars, CPT, Strategy, Utility, verbose=True):
    ...
    #OrderedVariables = DecVars + ChanceVars # topological
